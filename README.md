...
| Script | Current manuscript output |
| --- | --- |
| `fig01_lcc_sic_frequency.py` | Figure 1 |
| `fig02_lcc_omega_tadv.py` | Figure 2 |
| `fig03_lcc_sensitivity.py` | Figure 3 |
| `fig_s01_stability_indices.py` | Supporting Figure S1 |
| `fig_s02_s03_lcc_relationships.py` | Supporting Figures S2--S3 |
| `fig_s04_lcc_sensitivity_native_grid.py` | Supporting Figure S4 |
