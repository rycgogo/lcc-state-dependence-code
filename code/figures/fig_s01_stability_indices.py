...
data_file = project_dir / "data" / "LCC_CALIPSO_MODIS_ERA5_Tadv_2degx5deg_monthly_2007-2021.nc"
output_dir = project_dir / "outputs"
data_save_dir = os.path.join(output_dir, "Sensitivity_Data")

output_filename = "FigureS1_Stability_Scatter_Final.png"

summary_csv_filename = "FigureS1_Stability_Scatter_Stats.csv"
detailed_csv_filename = "FigureS1_Detailed_Bin_Data.csv"
...
try:
    ...
    # 5. Execution
    # ======================================================
    print("Plotting Supporting Figure S1...")
    ...
    print(f"[Success] Supporting Figure S1 saved to: {save_path}")
