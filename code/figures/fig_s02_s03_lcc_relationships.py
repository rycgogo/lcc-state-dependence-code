# ==========================================================
# This script plots Supporting Figures S2 and S3:
#
# Figure S2: LCC as a function of EIS under different Ts regimes.
# Figure S3: LCC as a function of Ts under different EIS regimes.
#
# Outputs:
# 1. PNG figures
...
# Figure S2: LCC vs EIS under different Ts regimes
...
# Figure S3: LCC vs Ts under different EIS regimes
...
def main():
    ...
    try:
        ...
        # ==================================================
        # 7. Supporting Figure S2: LCC vs EIS under different Ts regimes
        # ==================================================
        print("\n" + "=" * 55)
        print("Generating Supporting Figure S2: LCC vs EIS under different Ts regimes")
        print("=" * 55)
        ...
        for idx, regime in enumerate(ts_regimes):
            ...
            rows_a.extend(
                make_point_csv_rows(
                    figure_name="Figure_S2_LCC_vs_EIS_by_Ts_Regimes",
        ...
        save_path_a_png = os.path.join(
            output_dir,
            "FigureS2_LCC_vs_EIS_by_Ts_Regimes.png",
        )

        save_path_a_csv = os.path.join(
            output_dir,
            "FigureS2_LCC_vs_EIS_by_Ts_Regimes_Data.csv",
        )
        ...
        # ==================================================
        # 8. Supporting Figure S3: LCC vs Ts under different EIS regimes
        # ==================================================
        print("\n" + "=" * 55)
        print("Generating Supporting Figure S3: LCC vs Ts under different EIS regimes")
        print("=" * 55)
        ...
        for idx, regime in enumerate(eis_regimes):
            ...
            rows_b.extend(
                make_point_csv_rows(
                    figure_name="Figure_S3_LCC_vs_Ts_by_EIS_Regimes",
        ...
        save_path_b_png = os.path.join(
            output_dir,
            "FigureS3_LCC_vs_Ts_by_EIS_Regimes.png",
        )

        save_path_b_csv = os.path.join(
            output_dir,
            "FigureS3_LCC_vs_Ts_by_EIS_Regimes_Data.csv",
        )
