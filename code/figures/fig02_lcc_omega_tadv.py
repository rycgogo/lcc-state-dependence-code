...
# Outputs
# -------
# 1. Figure2_LCC_Omega_Tadv_StateSpace.png
# 2. Figure2_LCC_Omega_Tadv_StateSpace_Data.csv
#
# ==========================================================
...
file_path_tadv = project_dir / "data" / "LCC_CALIPSO_MODIS_ERA5_Tadv_2degx5deg_monthly_2007-2021.nc"
file_path_omega = file_path_tadv
output_dir = project_dir / "outputs"

output_filename = "Figure2_LCC_Omega_Tadv_StateSpace.png"
csv_filename = "Figure2_LCC_Omega_Tadv_StateSpace_Data.csv"
...
try:
    with xr.open_dataset(file_path_tadv) as ds_tadv:
        ...
        # ==================================================
        print("[Log] Plotting combined Fig. 2...")
        ...
        print(f"\n[Success] Combined Fig. 2 saved to: {save_path}")
